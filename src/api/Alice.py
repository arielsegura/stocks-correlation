from src.internal.SimilarityCalculatorStrategy import SimilarityCalculatorStrategy
...
class Alice:
    ...
    def compare(self, company_x_name, company_y_name, criteria=CLOSE, strategy='cosine'):
